...
vicious.register(bat_widget, vicious.widgets.bat, "$1$2%", 61, "BAT0")

thermal_widget = wibox.widget.textbox()
vicious.register(thermal_widget, vicious.widgets.thermal, "$1RPM", 11, "core_rpm")

cpufreq_widget = wibox.widget.textbox()
vicious.register(cpufreq_widget, vicious.widgets.cpufreq, "$5", 11, "cpu0")
-- }}}
...
screen.connect_signal("request::desktop_decoration", function(s)
    ...
    s.mywibox.widget = {
        ...
        { -- Right widgets
            layout = wibox.layout.fixed.horizontal,
            separator, bat_widget,
            separator, thermal_widget,
            separator, cpufreq_widget,
